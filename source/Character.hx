	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pico':
				...
				case 'boomy':
				tex = Paths.getSparrowAtlas('Boomy','shared',true);
				frames = tex;
				animation.addByPrefix('idle', "Boomy Idle0", 24, false);
				animation.addByPrefix('singUP', 'Boomy Up0', 24, false);
				animation.addByPrefix('singDOWN', 'Boomy Down0', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'Boomy Left0', 24, false);
					animation.addByPrefix('singRIGHT', 'Boomy Right0', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'Boomy Right0', 24, false);
					animation.addByPrefix('singRIGHT', 'Boomy Left0', 24, false);
				}
